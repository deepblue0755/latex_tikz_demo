...
\begin{document}
\pagestyle{empty}
\begin{tikzpicture}[scale=1.0] %,shift={(-10,-20)}
    % Draw the grid
    ...
    % Draw a triangle
    \draw[line width=2pt,color=red] (-3,-6) -- (-3,-9) -- (-5,-8) -- cycle;
    
    % Draw a circle
    \draw[line width=2pt,color=red] (-7,-3) circle (2cm);

    % Draw an ellipse
    \draw[line width=2pt,color=blue] (-5,5) ellipse (2cm and 1cm);
